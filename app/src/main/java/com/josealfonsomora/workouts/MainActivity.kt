            ...
            WorkoutsTheme {
                ...
                Scaffold(
                    ...
                    Box (modifier = Modifier.padding(paddingValues)) {
                        NavHost(navController = navHostController, startDestination = DAILY_WORKOUT_ROUTE) {
    ...
    NavigationBar {
        BottomNavigationScreens.entries.forEach {
            ...
            BottomNavigationItem(
                ...
                icon = {
                    Icon(imageVector = it.icon, contentDescription = "Settings", tint = if(selected) Color.Red else Color.Black)
                }
            )
        }
    }
...
enum class BottomNavigationScreens(val route: String, val icon: ImageVector, @StringRes val label:Int) {
    WORKOUTS(DAILY_WORKOUT_ROUTE, Icons.TwoTone.Home, R.string.daily_workout_title),
    PLANNER(PLANNER_ROUTE, Icons.TwoTone.DateRange, R.string.planner_title),
